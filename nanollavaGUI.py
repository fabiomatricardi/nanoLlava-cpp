...
chat_handler = Llava15ChatHandler(clip_model_path="nanollava/nanollava-mmproj-f16.gguf")
llm = Llama(
  model_path="nanollava/nanollava-text-model-f16.gguf",
...
messages = [
    {"role": "system", "content": "You are an assistant who perfectly describes images."},
    {
        ...
        "content": [
            ...
            {"type" : "text", "text": "Describe this image in detail. If you know it, tell me the name of this place."}
        ]
    }
]
